...
namespace bakaChiefApplication.API.Migrations
{
    ...
    [Migration("20231223163358_refacto")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("bakaChiefApplication.API.DatabaseModels.RecipProductInfo", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("bakaChiefApplication.API.DatabaseModels.RecipProductInfo", b =>
                {
                    b.HasOne("bakaChiefApplication.API.DatabaseModels.ProductInfo", "ProductInfo")
                        .WithMany("RecipProductInfos")
            ...
            modelBuilder.Entity("bakaChiefApplication.API.DatabaseModels.ProductInfo", b =>
                {
                    b.Navigation("RecipProductInfos");
                });
